function [f,minimum,maximum,optimum_angles] = print_1D_graph(gamma_angle,N,T,Norm,Input_t_GHI_DHI_DNI_Load,Output_t_I_Ib_ReindlId_Ig_cosAOI_omega,at_bt_ct,range_of_optimum_points)
    ...
    for theta_1 = -90:90    
    	theta(1) = theta_1;   
        for i = 1:181
            V(theta_1+91,i) = normalized_energy_drawn_from_the_main_grid(gamma_angle,N,T,Norm,Input_t_GHI_DHI_DNI_Load,Output_t_I_Ib_ReindlId_Ig_cosAOI_omega,theta,at_bt_ct);
        end
    end
